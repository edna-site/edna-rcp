 ...
 * <!-- end-user-doc -->
 * @see org.edna.datamodel.datamodel.DatamodelPackage
 * @generated
 */
public class DatamodelSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case DatamodelPackage.PACKAGE:
      {
        org.edna.datamodel.datamodel.Package package_ = (org.edna.datamodel.datamodel.Package)theEObject;
        T result = casePackage(package_);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DatamodelPackage.COMPLEX_TYPE:
      {
      ...
      case DatamodelPackage.ELEMENT_DECLARATION:
      {
   ...
   * @generated
   */
  public T casePackage(org.edna.datamodel.datamodel.Package object)
  {
    return null;
  }

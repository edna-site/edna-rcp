...
public class XSPluginList implements java.io.Serializable {
     ...
     */
    private java.util.List<org.edna.kernel.xsdata.XSPluginItem> _XSPluginItemList;
    ...
    public XSPluginList() {
        super();
        this._XSPluginItemList = new java.util.ArrayList<org.edna.kernel.xsdata.XSPluginItem>();
    }
    ...
    public void addXSPluginItem(
            final org.edna.kernel.xsdata.XSPluginItem vXSPluginItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.edna.kernel.xsdata.XSPluginItem> enumerateXSPluginItem(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.edna.kernel.xsdata.XSPluginItem
     * at the given index
     */
    public org.edna.kernel.xsdata.XSPluginItem getXSPluginItem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.edna.kernel.xsdata.XSPluginItem) _XSPluginItemList.get(index);
    }
    ...
    public org.edna.kernel.xsdata.XSPluginItem[] getXSPluginItem(
        ...
        org.edna.kernel.xsdata.XSPluginItem[] array = new org.edna.kernel.xsdata.XSPluginItem[0];
        return (org.edna.kernel.xsdata.XSPluginItem[]) this._XSPluginItemList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.edna.kernel.xsdata.XSPluginItem> iterateXSPluginItem(
    ) {
     ...
     */
    public org.edna.kernel.xsdata.XSPluginItem removeXSPluginItemAt(
            final int index) {
        java.lang.Object obj = this._XSPluginItemList.remove(index);
        return (org.edna.kernel.xsdata.XSPluginItem) obj;
    }
     ...
     */
    public void setXSPluginItem(
            final org.edna.kernel.xsdata.XSPluginItem[] vXSPluginItemArray) {
        //-- copy array
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.edna.kernel.xsdata.XSPluginList
     */
    public static org.edna.kernel.xsdata.XSPluginList unmarshalXSPluginList(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.edna.kernel.xsdata.XSPluginList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.edna.kernel.xsdata.XSPluginList.class, reader);
    }

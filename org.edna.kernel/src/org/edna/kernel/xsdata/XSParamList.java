...
public class XSParamList implements java.io.Serializable {
     ...
     */
    private java.util.List<org.edna.kernel.xsdata.XSParamItem> _XSParamItemList;
    ...
    public XSParamList() {
        super();
        this._XSParamItemList = new java.util.ArrayList<org.edna.kernel.xsdata.XSParamItem>();
    }
    ...
    public void addXSParamItem(
            final org.edna.kernel.xsdata.XSParamItem vXSParamItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.edna.kernel.xsdata.XSParamItem> enumerateXSParamItem(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.edna.kernel.xsdata.XSParamItem
     * at the given index
     */
    public org.edna.kernel.xsdata.XSParamItem getXSParamItem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.edna.kernel.xsdata.XSParamItem) _XSParamItemList.get(index);
    }
    ...
    public org.edna.kernel.xsdata.XSParamItem[] getXSParamItem(
        ...
        org.edna.kernel.xsdata.XSParamItem[] array = new org.edna.kernel.xsdata.XSParamItem[0];
        return (org.edna.kernel.xsdata.XSParamItem[]) this._XSParamItemList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.edna.kernel.xsdata.XSParamItem> iterateXSParamItem(
    ) {
     ...
     */
    public org.edna.kernel.xsdata.XSParamItem removeXSParamItemAt(
            final int index) {
        java.lang.Object obj = this._XSParamItemList.remove(index);
        return (org.edna.kernel.xsdata.XSParamItem) obj;
    }
     ...
     */
    public void setXSParamItem(
            final org.edna.kernel.xsdata.XSParamItem[] vXSParamItemArray) {
        //-- copy array
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.edna.kernel.xsdata.XSParamList
     */
    public static org.edna.kernel.xsdata.XSParamList unmarshalXSParamList(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.edna.kernel.xsdata.XSParamList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.edna.kernel.xsdata.XSParamList.class, reader);
    }

...
public class XSOptionList implements java.io.Serializable {
     ...
     */
    private java.util.List<org.edna.kernel.xsdata.XSOptionItem> _XSOptionItemList;
    ...
    public XSOptionList() {
        super();
        this._XSOptionItemList = new java.util.ArrayList<org.edna.kernel.xsdata.XSOptionItem>();
    }
    ...
    public void addXSOptionItem(
            final org.edna.kernel.xsdata.XSOptionItem vXSOptionItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.edna.kernel.xsdata.XSOptionItem> enumerateXSOptionItem(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.edna.kernel.xsdata.XSOptionItem
     * at the given index
     */
    public org.edna.kernel.xsdata.XSOptionItem getXSOptionItem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.edna.kernel.xsdata.XSOptionItem) _XSOptionItemList.get(index);
    }
    ...
    public org.edna.kernel.xsdata.XSOptionItem[] getXSOptionItem(
        ...
        org.edna.kernel.xsdata.XSOptionItem[] array = new org.edna.kernel.xsdata.XSOptionItem[0];
        return (org.edna.kernel.xsdata.XSOptionItem[]) this._XSOptionItemList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.edna.kernel.xsdata.XSOptionItem> iterateXSOptionItem(
    ) {
     ...
     */
    public org.edna.kernel.xsdata.XSOptionItem removeXSOptionItemAt(
            final int index) {
        java.lang.Object obj = this._XSOptionItemList.remove(index);
        return (org.edna.kernel.xsdata.XSOptionItem) obj;
    }
     ...
     */
    public void setXSOptionItem(
            final org.edna.kernel.xsdata.XSOptionItem[] vXSOptionItemArray) {
        //-- copy array
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.edna.kernel.xsdata.XSOptionList
     */
    public static org.edna.kernel.xsdata.XSOptionList unmarshalXSOptionList(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.edna.kernel.xsdata.XSOptionList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.edna.kernel.xsdata.XSOptionList.class, reader);
    }

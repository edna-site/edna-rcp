...
public class TestCaseExecuteCCP4iv1_1_lapsvensson extends TestCase {
	...
	public void testExecute() throws Exception {
		...
		imagePath.setValue( "/home/svensson/WorkSpace-350/edna/tests/data/images/ref-testscale_1_001.img" );
		...
		launcher.setEdnaHome(new File("/home/svensson/WorkSpace-350/edna"));
		launcher.setEdnaSite("lapsvensson");
